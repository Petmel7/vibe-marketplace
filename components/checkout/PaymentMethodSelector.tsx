...
const PAYMENT_METHOD_OPTIONS: Array<{
...
}> = [
  {
    ...
    description: 'Онлайн-оплата. Після створення замовлення може знадобитися підтвердження у платіжного провайдера.',
  },
  {
    value: 'CASH_ON_DELIVERY',
    label: 'Післяплата',
    description: 'Оплата під час отримання замовлення. Замовлення буде створене одразу, а оплата зафіксується пізніше.',
  },
]
...
export default function PaymentMethodSelector({
  ...
  return (
    <fieldset
      className="ui-elevated-panel space-y-4 p-5 sm:p-6"
      aria-invalid={Boolean(errorMessage)}
      aria-describedby={describedBy}
      disabled={disabled}
    >
      <legend className="text-base font-semibold text-copy-strong">Спосіб оплати</legend>
      <p className="text-sm text-copy-muted">
        Оберіть, як ви хочете завершити покупку. Підсумки та фінальна доступність товарів усе одно перевіряються на сервері.
      </p>
