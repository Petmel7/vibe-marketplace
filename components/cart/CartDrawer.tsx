      ...
      <div className="md:flex md:items-start md:gap-8">
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-6 flex flex-col md:flex-row md:items-center md:gap-6">
            <div className="rounded-xl border border-panelBorder bg-panel overflow-hidden md:w-60 md:shrink-0">
              <input
                type="text"
                value={promoCode}
                onChange={(e) => setPromoCode(e.target.value)}
                placeholder="Промокод"
                className="ui-surface-input-plain h-12"
                aria-label="Промокод"
              />
              <p className="ui-body-secondary px-4 pb-3 md:hidden">
        ...
        <div className="mt-6 md:sticky md:top-24 md:mt-0 md:w-108 md:shrink-0">
