        ...
        <div className="flex touch-pan-y">
          {banners.map((banner, index) => {
            ...
            return (
              ...
              >
                  <div className="relative min-h-90 overflow-hidden sm:min-h-107.5 lg:min-h-140">
                  ...
                  <div className="relative z-10 flex min-h-90 items-center px-5 py-10 sm:min-h-107.5 sm:px-10 lg:min-h-140 lg:px-16">
