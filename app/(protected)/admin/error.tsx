...
export default function Error({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-panelBorder bg-panel/60 px-6 py-10 text-center">
      <h2 className="text-lg font-semibold text-copy-strong">We could not load this admin section</h2>
      <p className="mx-auto mt-2 max-w-xl text-sm text-copy-muted">
        Please try again. If the problem continues, the admin session or the marketplace data source may need to be refreshed.
      </p>
